...
// SetComments sets the "comments" field.
func (m *RoleMutation) SetComments(s string) {
	m.comments = &s
}

// Comments returns the value of the "comments" field in the mutation.
func (m *RoleMutation) Comments() (r string, exists bool) {
	v := m.comments
	if v == nil {
		return
	}
...
// OldComments returns the old "comments" field's value of the Role entity.
// If the Role object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *RoleMutation) OldComments(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldComments is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetComments resets all changes to the "comments" field.
func (m *RoleMutation) ResetComments() {
	m.comments = nil
}
...
func (m *RoleMutation) RemovedResourcesIDs() (ids []int) {
...
func (m *RoleMutation) ResourcesIDs() (ids []int) {
...
func (m *RoleMutation) Fields() []string {
	...
	if m.comments != nil {
		fields = append(fields, role.FieldComments)
	}
	return fields
}
