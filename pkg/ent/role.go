...
func (e RoleEdges) ResourcesOrErr() ([]*Resource, error) {
	if e.loadedTypes[0] {
...
func (*Role) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		switch columns[i] {
		case role.FieldID, role.FieldLevel:
			values[i] = new(sql.NullInt64)
		case role.FieldName, role.FieldComments:
...
// QueryResources queries the "resources" edge of the Role entity.
func (r *Role) QueryResources() *ResourceQuery {
	return (&RoleClient{config: r.config}).QueryResources(r)
}
